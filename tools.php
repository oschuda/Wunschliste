...
<style>
    ...
    .btn-install { background: #27ae60; color: #fff !important; padding: 12px 25px; text-decoration: none; border-radius: 6px; display: inline-block; margin: 15px 0; font-weight: bold; font-size: 1.1em; transition: transform 0.2s, background 0.3s; border: none; }
    .btn-install:hover { background: #2ecc71; transform: scale(1.05); }
...
<div class="container">
    ...
    <a href="wishlist-adder.user.js" class="btn-install">?? Script jetzt installieren</a>
    ...
    <div class="key-box">
        ...
        try {
            ...
            echo htmlspecialchars($u["api_key"] ?? "Profil öffnen!");
...
<p style="margin-top: 30px;"><a href="index.php" style="color: #666;">&larr; Zurück zum Dashboard</a></p>
</body></html>
